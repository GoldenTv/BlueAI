...
// .wrangler/tmp/bundle-tgVYSO/checked-fetch.js
...
// .wrangler/tmp/bundle-tgVYSO/strip-cf-connecting-ip-header.js
...
// .wrangler/tmp/bundle-tgVYSO/middleware-loader.entry.ts
init_checked_fetch();
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();

// .wrangler/tmp/bundle-tgVYSO/middleware-insertion-facade.js
init_checked_fetch();
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
...
var _a2;
var APICallError = /* @__PURE__ */ __name(class extends AISDKError {
  constructor({
    message,
    url,
    requestBodyValues,
...
var _a3;
var EmptyResponseBodyError = /* @__PURE__ */ __name(class extends AISDKError {
  // used in isInstance
...
var _a5;
var InvalidPromptError = /* @__PURE__ */ __name(class extends AISDKError {
  constructor({
    prompt,
    message,
    cause
...
var _a6;
var InvalidResponseDataError = /* @__PURE__ */ __name(class extends AISDKError {
  constructor({
    data,
...
var _a8;
var LoadAPIKeyError = /* @__PURE__ */ __name(class extends AISDKError {
  // used in isInstance
  constructor({ message }) {
...
var _a12;
var TooManyEmbeddingValuesForCallError = /* @__PURE__ */ __name(class extends AISDKError {
  constructor(options) {
    super({
      name: name11,
...
var _a14;
var UnsupportedFunctionalityError = /* @__PURE__ */ __name(class extends AISDKError {
  constructor({
    functionality,
...
var UnsupportedModelVersionError = /* @__PURE__ */ __name(class extends AISDKError {
  constructor() {
    super({
...
var _a15;
var InvalidArgumentError2 = /* @__PURE__ */ __name(class extends AISDKError {
  constructor({
    parameter,
    value,
    message
...
var _a22;
var RetryError = /* @__PURE__ */ __name(class extends AISDKError {
  constructor({
    message,
    reason,
    errors
...
var _a52;
var DownloadError = /* @__PURE__ */ __name(class extends AISDKError {
  constructor({
    url,
    statusCode,
    statusText,
...
var _a62;
var InvalidDataContentError = /* @__PURE__ */ __name(class extends AISDKError {
  constructor({
    content,
    cause,
...
var _a72;
var InvalidMessageRoleError = /* @__PURE__ */ __name(class extends AISDKError {
  constructor({
    role,
...
var _a82;
var MessageConversionError = /* @__PURE__ */ __name(class extends AISDKError {
  constructor({
    originalMessage,
    message
  }) {
...
var _a92;
var NoOutputSpecifiedError = /* @__PURE__ */ __name(class extends AISDKError {
  // used in isInstance
...
var _a102;
var ToolExecutionError = /* @__PURE__ */ __name(class extends AISDKError {
  constructor({
    toolArgs,
    toolName,
    toolCallId,
...
var _a112;
var InvalidToolArgumentsError = /* @__PURE__ */ __name(class extends AISDKError {
  constructor({
    toolArgs,
    toolName,
    cause,
...
var _a122;
var NoSuchToolError = /* @__PURE__ */ __name(class extends AISDKError {
  constructor({
    toolName,
...
var _a132;
var ToolCallRepairError = /* @__PURE__ */ __name(class extends AISDKError {
  constructor({
    cause,
    originalError,
...
var _a142;
var InvalidStreamPartError = /* @__PURE__ */ __name(class extends AISDKError {
  constructor({
    chunk,
    message
  }) {
...
__name(getPotentialStartIndex, "getPotentialStartIndex");
...
__name(extractReasoningMiddleware, "extractReasoningMiddleware");
var wrapLanguageModel = /* @__PURE__ */ __name(({
  model,
...
var doWrap = /* @__PURE__ */ __name(({
  ...
  __name(doTransform, "doTransform");
  return {
    ...
    async doGenerate(params) {
      ...
      const doGenerate = /* @__PURE__ */ __name(async () => model.doGenerate(transformedParams), "doGenerate");
      const doStream = /* @__PURE__ */ __name(async () => model.doStream(transformedParams), "doStream");
...
var OpenAITranscriptionModel = /* @__PURE__ */ __name(class {
...
var OpenAISpeechModel = /* @__PURE__ */ __name(class {
  constructor(modelId, config) {
    this.modelId = modelId;
    this.config = config;
    this.specificationVersion = "v1";
...
function extractReasoningFromRecord(rec) {
  if (!rec || typeof rec !== "object")
    return "";
  let res = "";
  for (const key of REASONING_KEYS) {
    if (key in rec && rec[key] != null) {
      const text2 = extractText(rec[key]);
      if (text2)
        res += text2;
    }
  }
...
__name(extractReasoningFromRecord, "extractReasoningFromRecord");
function cleanReasoningKeys(rec) {
  if (!rec || typeof rec !== "object")
    return;
  for (const key of REASONING_KEYS) {
    if (key in rec) {
...
__name(cleanReasoningKeys, "cleanReasoningKeys");
function extractFromContentArray(content) {
  ...
  return { text: text2, reasoning };
}
__name(extractFromContentArray, "extractFromContentArray");
function normalizeGatewayStream(body) {
  const decoder = new TextDecoder();
  const encoder = new TextEncoder();
  let buffer = "";
  let inReasoning = false;
  let completed = false;
  function line(raw, controller) {
...
`));
  ...
  return body.pipeThrough(new TransformStream({
    ...
    flush(controller) {
      ...
      if (!completed)
        throw new Error("\u0E01\u0E32\u0E23\u0E2A\u0E15\u0E23\u0E35\u0E21\u0E02\u0E49\u0E2D\u0E21\u0E39\u0E25\u0E08\u0E32\u0E01 Gateway \u0E2A\u0E34\u0E49\u0E19\u0E2A\u0E38\u0E14\u0E25\u0E07\u0E01\u0E48\u0E2D\u0E19\u0E1E\u0E1A\u0E2A\u0E31\u0E0D\u0E0D\u0E32\u0E13\u0E2A\u0E34\u0E49\u0E19\u0E2A\u0E38\u0E14\u0E04\u0E33\u0E15\u0E2D\u0E1A");
    }
  }));
}
__name(normalizeGatewayStream, "normalizeGatewayStream");
...
var CloudStore = class {
  ...
  constructor(env, token) {
    if (!env.SUPABASE_URL || !env.SUPABASE_PUBLISHABLE_KEY)
      throw new ApiError("NOT_CONFIGURED", "\u0E22\u0E31\u0E07\u0E44\u0E21\u0E48\u0E44\u0E14\u0E49\u0E15\u0E31\u0E49\u0E07\u0E04\u0E48\u0E32 Supabase \u0E1A\u0E19 Worker", 503);
  ...
  async call(path, body) {
    ...
    try {
      ...
      throw new ApiError("STORAGE_UNAVAILABLE", "\u0E15\u0E34\u0E14\u0E15\u0E48\u0E2D\u0E10\u0E32\u0E19\u0E02\u0E49\u0E2D\u0E21\u0E39\u0E25\u0E44\u0E21\u0E48\u0E44\u0E14\u0E49 \u0E01\u0E23\u0E38\u0E13\u0E32\u0E25\u0E2D\u0E07\u0E43\u0E2B\u0E21\u0E48", 503);
    }
    const result = await response.json().catch(() => ({}));
    if (!response.ok) {
      const message = String(result.message ?? result.msg ?? "");
      if (response.status === 401)
        throw new ApiError("AUTH_EXPIRED", "\u0E01\u0E23\u0E38\u0E13\u0E32\u0E40\u0E02\u0E49\u0E32\u0E2A\u0E39\u0E48\u0E23\u0E30\u0E1A\u0E1A\u0E2D\u0E35\u0E01\u0E04\u0E23\u0E31\u0E49\u0E07", 401);
      const errors = { ROOM_NOT_FOUND: "\u0E44\u0E21\u0E48\u0E1E\u0E1A\u0E2B\u0E49\u0E2D\u0E07\u0E2B\u0E23\u0E37\u0E2D\u0E44\u0E21\u0E48\u0E21\u0E35\u0E2A\u0E34\u0E17\u0E18\u0E34\u0E4C\u0E40\u0E02\u0E49\u0E32\u0E16\u0E36\u0E07", ROOM_BUSY: "\u0E2B\u0E49\u0E2D\u0E07\u0E19\u0E35\u0E49\u0E01\u0E33\u0E25\u0E31\u0E07\u0E15\u0E2D\u0E1A\u0E08\u0E32\u0E01\u0E2D\u0E35\u0E01\u0E2D\u0E38\u0E1B\u0E01\u0E23\u0E13\u0E4C", REQUEST_CONFLICT: "\u0E23\u0E2B\u0E31\u0E2A\u0E04\u0E33\u0E02\u0E2D\u0E19\u0E35\u0E49\u0E16\u0E39\u0E01\u0E43\u0E0A\u0E49\u0E41\u0E25\u0E49\u0E27", INVALID_INPUT: "\u0E02\u0E49\u0E2D\u0E21\u0E39\u0E25\u0E44\u0E21\u0E48\u0E16\u0E39\u0E01\u0E15\u0E49\u0E2D\u0E07", EMPTY_ANSWER: "\u0E42\u0E21\u0E40\u0E14\u0E25\u0E22\u0E31\u0E07\u0E44\u0E21\u0E48\u0E2A\u0E48\u0E07\u0E04\u0E33\u0E15\u0E2D\u0E1A\u0E2B\u0E25\u0E31\u0E01" };
      for (const [code, detail] of Object.entries(errors)) {
        if (message.includes(code))
          throw new ApiError(code, detail, code === "ROOM_NOT_FOUND" ? 404 : code === "INVALID_INPUT" ? 400 : 409);
      }
  ...
  rpc(name17, body) {
    return this.call(`/rest/v1/rpc/${name17}`, body);
  }
  async history(room) {
...
__name(CloudStore, "CloudStore");

// src/index.ts
var UUID = /^[0-9a-f]{8}-[0-9a-f]{4}-[1-8][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/i;
var SYSTEM_PROMPT = "You are BlueAI, a helpful, intelligent, and friendly AI assistant. When thinking through problems, coding tasks, or questions, you may include your thought process and reasoning inside <think>...</think> tags before providing the final answer. Always provide clear and well-structured answers in Thai or English as requested. Use Markdown formatting and LaTeX for all mathematical formulas: use $...$ or \\(...\\) for inline math, and $$...$$ or \\[...\\] for block math.";
function cors(request, env) {
  ...
  return {
    ...
    "Access-Control-Allow-Headers": "Authorization, Content-Type, X-AI-API-Key",
...
async function readBody(request) {
  if (Number(request.headers.get("Content-Length") ?? 0) > 2e6)
    throw new ApiError("INVALID_INPUT", "\u0E02\u0E49\u0E2D\u0E21\u0E39\u0E25\u0E21\u0E35\u0E02\u0E19\u0E32\u0E14\u0E43\u0E2B\u0E0D\u0E48\u0E40\u0E01\u0E34\u0E19\u0E44\u0E1B", 413);
  ...
  try {
    ...
    throw new ApiError("INVALID_INPUT", "\u0E02\u0E49\u0E2D\u0E21\u0E39\u0E25 JSON \u0E44\u0E21\u0E48\u0E16\u0E39\u0E01\u0E15\u0E49\u0E2D\u0E07", 400);
  }
}
...
var src_default = {
  async fetch(request, env, ctx) {
    ...
    if (request.method !== "POST")
      return json({ code: "METHOD_NOT_ALLOWED", error: "\u0E42\u0E1B\u0E23\u0E14\u0E43\u0E0A\u0E49 POST" }, 405, headers);
    const stop = path.match(/^\/v1\/chat\/([0-9a-f-]+)\/stop$/i);
    if (path !== "/v1/chat" && !stop)
      return json({ code: "NOT_FOUND", error: "\u0E44\u0E21\u0E48\u0E1E\u0E1A API \u0E19\u0E35\u0E49" }, 404, headers);
    try {
      const match = request.headers.get("Authorization")?.match(/^Bearer (\S+)$/i);
      if (!match)
        throw new ApiError("AUTH_REQUIRED", "\u0E01\u0E23\u0E38\u0E13\u0E32\u0E40\u0E02\u0E49\u0E32\u0E2A\u0E39\u0E48\u0E23\u0E30\u0E1A\u0E1A", 401);
      const store = new CloudStore(env, match[1]);
      await store.authenticate();
      if (stop) {
        if (!UUID.test(stop[1]))
          throw new ApiError("INVALID_INPUT", "\u0E23\u0E2B\u0E31\u0E2A\u0E04\u0E33\u0E02\u0E2D\u0E44\u0E21\u0E48\u0E16\u0E39\u0E01\u0E15\u0E49\u0E2D\u0E07", 400);
        const body2 = await readBody(request);
        if (typeof body2.content === "string")
          await store.rpc("save_chat", {
            p_request_id: stop[1],
            p_content: body2.content,
            p_reasoning: typeof body2.reasoning === "string" ? body2.reasoning : "",
            p_status: "stopped"
          });
      ...
      for (const field of ["conversationId", "requestId", "messageId"]) {
        if (typeof body[field] !== "string" || !UUID.test(body[field]))
          throw new ApiError("INVALID_INPUT", "\u0E23\u0E2B\u0E31\u0E2A\u0E2B\u0E49\u0E2D\u0E07\u0E2B\u0E23\u0E37\u0E2D\u0E02\u0E49\u0E2D\u0E04\u0E27\u0E32\u0E21\u0E44\u0E21\u0E48\u0E16\u0E39\u0E01\u0E15\u0E49\u0E2D\u0E07", 400);
      }
      if (typeof body.prompt !== "string" || !body.prompt.trim() || body.prompt.length > 32e3 || typeof body.model !== "string" || !body.model.trim() || body.model.length > 200) {
        throw new ApiError("INVALID_INPUT", "\u0E02\u0E49\u0E2D\u0E04\u0E27\u0E32\u0E21\u0E2B\u0E23\u0E37\u0E2D\u0E42\u0E21\u0E40\u0E14\u0E25\u0E44\u0E21\u0E48\u0E16\u0E39\u0E01\u0E15\u0E49\u0E2D\u0E07", 400);
      }
      const apiKey = request.headers.get("X-AI-API-Key")?.trim();
      if (!apiKey)
        throw new ApiError("AI_KEY_REQUIRED", "\u0E42\u0E1B\u0E23\u0E14\u0E43\u0E2A\u0E48 API Key \u0E43\u0E19\u0E2B\u0E19\u0E49\u0E32\u0E15\u0E31\u0E49\u0E07\u0E04\u0E48\u0E32", 400);
      if (request.signal.aborted)
        throw new ApiError("INTERRUPTED", "\u0E22\u0E01\u0E40\u0E25\u0E34\u0E01\u0E04\u0E33\u0E02\u0E2D\u0E41\u0E25\u0E49\u0E27", 409);
      const reservation = await store.rpc("begin_chat", {
        p_conversation_id: body.conversationId,
        p_request_id: body.requestId,
        p_message_id: body.messageId,
        p_prompt: body.prompt.trim(),
        p_model: body.model.trim()
      });
      if (!reservation.started)
        return json({ code: "REQUEST_EXISTS", run: reservation.run }, 409, headers);
...
function startStream(request, env, store, body, apiKey, headers, ctx) {
  ...
  const keepAlive = /* @__PURE__ */ __name((p) => {
    ctx?.waitUntil(p);
    p.catch(() => {
    });
  }, "keepAlive");
  function save(status, code, error) {
    const snapshot = {
      p_request_id: body.requestId,
      p_content: content,
      ...
      p_thinking_seconds: thinkingSeconds
    };
    dirty = false;
    const task = writes.catch(() => {
    }).then(async () => {
  ...
  function onAbort() {
    ...
    cleanup();
    if (!terminal)
      keepAlive(save("interrupted", "INTERRUPTED", "\u0E01\u0E32\u0E23\u0E40\u0E0A\u0E37\u0E48\u0E2D\u0E21\u0E15\u0E48\u0E2D\u0E16\u0E39\u0E01\u0E02\u0E31\u0E14\u0E08\u0E31\u0E07\u0E2B\u0E27\u0E30"));
  }
      ...
      const pump = /* @__PURE__ */ __name(async () => {
        try {
          ...
          const provider = createOpenAI({
            baseURL: (env.AI_BASE_URL || "https://ai.psu.blue/v1").replace(/\/$/, ""),
            apiKey,
            compatibility: "compatible",
            fetch: async (input, init) => {
              const response = await fetch(input, init);
              return response.body && response.headers.get("content-type")?.includes("text/event-stream") ? new Response(normalizeGatewayStream(response.body), { status: response.status, headers: response.headers }) : response;
            }
          });
          const resetIdle = /* @__PURE__ */ __name(() => {
            clearTimeout(idle);
            idle = setTimeout(() => abort.abort(new Error("TIMEOUT")), 9e4);
          }, "resetIdle");
          resetIdle();
          timer = setInterval(() => {
            if (terminal || !dirty && Date.now() - lastSaved < 2e4 || checkpointPending)
              return;
            checkpointPending = true;
            keepAlive(save("streaming").then((status2) => {
              if (status2 !== "streaming")
                abort.abort();
            }).catch(() => abort.abort(new Error("SAVE_FAILED"))).finally(() => {
              checkpointPending = false;
            }));
          }, 2e3);
          const result = streamText({
            model: wrapLanguageModel({ model: provider(body.model), middleware: extractReasoningMiddleware({ tagName: "think" }) }),
          ...
          for await (const part of result.fullStream) {
            ...
            if (part.type === "error")
              throw new ApiError("GATEWAY_ERROR", "\u0E42\u0E21\u0E40\u0E14\u0E25\u0E15\u0E2D\u0E1A\u0E01\u0E25\u0E31\u0E1A\u0E44\u0E21\u0E48\u0E2A\u0E33\u0E40\u0E23\u0E47\u0E08", 502);
            if (part.type === "finish") {
              finished = part.finishReason === "stop";
            }
            if (part.type === "text-delta" || part.type === "reasoning") {
              if (part.type === "text-delta") {
                if (thinkingSeconds === null && part.textDelta)
                  thinkingSeconds = Math.max(1, Math.floor((Date.now() - started) / 1e3));
          ...
          if (!finished || !content.trim())
            throw new ApiError("INCOMPLETE_RESPONSE", "\u0E42\u0E21\u0E40\u0E14\u0E25\u0E22\u0E31\u0E07\u0E44\u0E21\u0E48\u0E2A\u0E48\u0E07\u0E04\u0E33\u0E15\u0E2D\u0E1A\u0E2B\u0E25\u0E31\u0E01\u0E17\u0E35\u0E48\u0E2A\u0E21\u0E1A\u0E39\u0E23\u0E13\u0E4C", 502);
          cleanup();
          const status = await save("completed");
          if (status !== "completed")
            throw new ApiError("INTERRUPTED", "\u0E04\u0E33\u0E15\u0E2D\u0E1A\u0E16\u0E39\u0E01\u0E2B\u0E22\u0E38\u0E14\u0E01\u0E48\u0E2D\u0E19\u0E40\u0E2A\u0E23\u0E47\u0E08", 409);
          if (!closed) {
            controller.enqueue(encoder.encode("data: [DONE]\n\n"));
            controller.close();
            closed = true;
          ...
          try {
            if (!terminal)
              await save(closed || request.signal.aborted ? "interrupted" : "error", code, message);
          } catch {
            code = "SAVE_FAILED";
            message = "\u0E22\u0E31\u0E07\u0E22\u0E37\u0E19\u0E22\u0E31\u0E19\u0E01\u0E32\u0E23\u0E1A\u0E31\u0E19\u0E17\u0E36\u0E01\u0E44\u0E21\u0E48\u0E44\u0E14\u0E49 \u0E01\u0E23\u0E38\u0E13\u0E32\u0E40\u0E0A\u0E37\u0E48\u0E2D\u0E21\u0E15\u0E48\u0E2D\u0E41\u0E25\u0E49\u0E27\u0E15\u0E23\u0E27\u0E08\u0E1A\u0E17\u0E2A\u0E19\u0E17\u0E19\u0E32\u0E2D\u0E35\u0E01\u0E04\u0E23\u0E31\u0E49\u0E07";
          }
          if (!closed) {
...
__name(startStream, "startStream");
